...
<center>
<br />
<h3>Kitchen tile modifications</h3>
<?php
//declare variables
$server='localhost';
$user='root';
...
?>
<!--Form for moadify kitchen tiles-->
...
$sql="INSERT INTO kitches VALUES(".$id.",'".$type."','".$name."','".$size."','".$price."','".$image."')";/*insert data to database kitchen table */
...
$sql="UPDATE kitches SET type='".$type."', product='".$name."', size='".$size."',price='".$price."',image='".$image."' where id=".$id."";// Update data in datbase kitchen tabele
	if(mysqli_query($conn,$sql))
...
{
$sql="DELETE FROM kitches where id=".$id."";// Delete data from database kitchen table
	if(mysqli_query($conn,$sql))
...
$sql="SELECT * FROM kitches WHERE id='".$id."'";// select data from datbase kitchen table
