...
<div class="container">
  ...
  <!--drop down buttons-->
    ...
    <ul class="dropdown-menu" role="menu">
      ...
      <li><a href="index.php?page=bathrooms"> Bat</a></li>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		$t=$_POST['type'];
		$s=$_POST['size'];
		$sql = "SELECT * FROM bathrooms where type='".$t."' AND size='".$s."" ;//select data from bathroom table
...
?>
<h1 style="color:#0CF;">Bathroom Tiles</h1>
<?php

$sql="SELECT * FROM bathrooms";// select all data from bathrooms table
